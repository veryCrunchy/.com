import { applyManifestFormEdits, updateStudioManifestMetadata } from "~/server/utils/photo-ingest-studio";
...
export default defineEventHandler(async (event) => {
  ...
  return await updateStudioManifestMetadata(event, manifest);
});
