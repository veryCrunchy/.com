<script setup lang="ts">
  ...
  const copy = {
    en: {
      ...
      formIntro:
        "Everything below is just to help me identify your photos properly. The sharing preference here is only your default, and you’ll be able to review it per photo later.",
      matchedFormTitle: "Just the essentials",
      matchedFormIntro:
        "Your photos have already been matched, so I only need a contact detail and your default sharing preference. You’ll still be able to review each photo individually later.",
      ...
      publishConsent: "You may publish recognisable photos of me by default",
      publishHelp: "Optional. You’ll still receive your photos either way, and you can update sharing permission per photo later.",
      submit: "Send details",
      submitting: "Sending…",
    ...
    nl: {
      ...
      formIntro:
        "Alles hieronder helpt me alleen om jouw foto’s goed te herkennen. De publicatievoorkeur hier is alleen je standaardinstelling, en je kunt dit later per foto aanpassen.",
      matchedFormTitle: "Alleen het nodige",
      matchedFormIntro:
        "Je foto’s zijn al gekoppeld, dus ik heb alleen nog een contactgegeven en je standaardvoorkeur voor openbare publicatie nodig. Later kun je dit nog per foto aanpassen.",
      ...
      publishConsent: "Je mag herkenbare foto’s van mij standaard openbaar publiceren",
      publishHelp: "Optioneel. Je ontvangt je foto’s hoe dan ook, en je kunt de toestemming later per foto aanpassen.",
